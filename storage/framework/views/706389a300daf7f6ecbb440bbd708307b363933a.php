...
<p>Whether you’re planning the perfect bachelorette or bachelor party, chartering a boat enables you to visit more stunning places while having a floating home-base to return to. So, for the best <a href="/" target="_self">SAG HARBOR BOAT RENTAL</a> options or more information about our most popular charters, please click below to go to our boats page.</p>
    ...
    <section>
        <img class="d-block w-100 lazyload" data-aos="fade-center" data-aos-duration="1000" data-src="<?php echo e(asset('/photos/2/bachelorette-party/bachelor-9.jpg')); ?>">
    </section>
...
<?php echo $__env->make('frontend.mainframe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/ncwfegko/public_html/resources/views/frontend/templates/bachelorette.blade.php ENDPATH**/ ?>