...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo e(url('/dashboard/pages/add')); ?>">Add Page</a>
                <?php } if($r->can_read == 'on') {  ?>
                <a class="collapse-item" href="<?php echo e(url('/dashboard/pages/all')); ?>">All Pages</a>
                <?php } ?>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <?php if($r->can_read == 'on') { ?>
                <a class="collapse-item" href="<?php echo e(url('/dashboard/boats')); ?>">All</a>
                <?php } if($r->can_write == 'on') {  ?>
                <a class="collapse-item" href="<?php echo e(url('/dashboard/boats-add')); ?>">Add Boats</a>
                <a class="collapse-item" href="<?php echo e(url('/dashboard/boat-categories')); ?>">Categories</a>
                <?php } ?>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <?php if($r->can_write == 'on') { ?>
                <a class="collapse-item" href="<?php echo e(url('/dashboard/sliders/add')); ?>">Add New</a>
                <?php } if($r->can_read == 'on') {  ?>
                <a class="collapse-item" href="<?php echo e(url('/dashboard/sliders')); ?>">Sliders List</a>
                <?php } ?>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseDest" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <?php if($r->can_write == 'on') { ?>
                <a class="collapse-item" href="<?php echo e(url('/dashboard/add-destination')); ?>">Add Destination</a>
                <?php } if($r->can_read == 'on') {  ?>
                <a class="collapse-item" href="<?php echo e(url('/dashboard/list-destinations')); ?>">All Destinations</a>
                <?php } ?>
            </div>
        </div>
    </li>
    ...
    <!-- <li class="nav-item">
        <a class="nav-link" href="<?php echo e(url('/dashboard/logo')); ?>">
    ...
    <li class="nav-item">
        ...
        <div id="collapseUsers" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <?php if($r->can_write == 'on') { ?>
                <a class="collapse-item" href="<?php echo e(url('/dashboard/add-user')); ?>">Add User</a>
                <?php } if($r->can_read == 'on') {  ?>
                <a class="collapse-item" href="<?php echo e(url('/dashboard/list-users')); ?>">All Users</a>
                <?php } ?>
            </div>
        </div>
    </li>
    ...
    ?>
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(url('/dashboard/menus')); ?>">
            <i class="fas fa-fw fa-list"></i>
            <span>Menus</span></a>
    </li>
    <?php }}} ?>
    ...
    ?>
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(url('/dashboard/contact-forms')); ?>">
    ...
    ?>
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(url('/dashboard/media-library')); ?>">
    ...
    <!-- Nav Item - Charts -->
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(url('/dashboard/settings')); ?>">
    ...
    <li class="nav-item">
        ...
        <div id="collapseSettings" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(url('/dashboard/add-role')); ?>">Add Role</a>
                <a class="collapse-item" href="<?php echo e(url('/dashboard/list-roles')); ?>">All Roles</a>
            </div>
        </div>
    </li>
    <?php } ?>
    ...
    <div class="side-users">
        ...
        ?>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(url('/dashboard/add-user/'.$u->id)); ?>">
...
</ul><?php /**PATH /home1/ncwfegko/public_html/resources/views/admin/includes/sidebar.blade.php ENDPATH**/ ?>