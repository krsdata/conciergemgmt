            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="widget footerLogoBox">
                      ...
                      <a href="./"><img class="img-responsive lazyload" data-src="<?php echo e(asset('/logo-f.svg')); ?>" alt="hamptonsboatrental-footer-logo"/></a>
                      </div> 
                      ...
                      <ul class="cms-addres-list">
                        ...
                        <li>
                            <div class="media"> 
                                ...
                                <div class="media-body"> 
                                        <a href="sms:+16315007777">Click to Text: +1-631-500-7777</a>
                                </div> 
                            </div>
                        </li>
                        <li>
                ...
                <div class="col-lg-12 text-white">
                    <div class="copyright">
                          ...
                          <ul class="social-list-cms">
                                <li>
                                    <a href="https://www.facebook.com/hamptonsboatrental" target="_blank">
                                        <i class="fa fa-facebook"></i>
                                    </a>    
                                </li>    
                                <li>
                                    <a href="https://www.instagram.com/hamptonsboatrental" target="_blank">
                        ...
                        2020 &copy; Copyright <a href="value" target="_blank" class="text-white">Reserved</a> to <a class="text-white" href="hamptons-to-do">Yacht Hampton</a> <a class="text-white" href="https://hamptonsboatrental.com/login" target="_blank">by</a> <a class="text-white" href="https://hamptonsboatrental.com" target="_blank">Hamptons Boat Rental</a>
                       </div></div>  
                    </div>
                </div>
            </div>
...
</footer><?php /**PATH /home1/ncwfegko/template.yachthampton.com/public_html/resources/views/frontend/includes/footer.blade.php ENDPATH**/ ?>