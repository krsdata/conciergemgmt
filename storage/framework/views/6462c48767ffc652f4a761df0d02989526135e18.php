...
<div class="counting">
    ...
    <?php $odd = true; foreach ($destinations as $dest) { if($dest->sort == 0 || $dest->sort == "" || $dest->sort ==  null || $dest->cat_id !== 1) continue; ?>
                            ...
                            <div class="rows">
                                <div class="col-sm-6">
                                    <div class="inn_boxes_cont_sec_lt" data-aos="fade-up" data-aos-duration="1500">
                                        <h2><a href="<?php echo $dest->slug; ?>"><?php echo $dest->page_name; ?></a></h2><p class="mt-3 normal"><span style="font-size: 14pt;"><?php echo $dest->short_description; ?></span></p><span><a class="nice-button-blue blue-button" href="<?php echo $dest->slug; ?>" target="_blank" rel="noopener">Learn More</a></span>
                                        </div></div>
...
<?php echo $__env->make('frontend.mainframe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/ncwfegko/public_html/resources/views/frontend/templates/local-destinations.blade.php ENDPATH**/ ?>