<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <form method="POST" action="<?php echo e(url('/dashboard/boats-add')); ?>" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control col-md-8 counting" name="slug" type="text" value="<?php echo e(old('slug')); ?>">
                            </div>
                            <!--  <div class="form-group">
                                <label class="font-weight-bold">Content</label>
                                <textarea name="content" class="form-control my-editor"
                                          style="min-height: 500px;"><?php echo e(old('content')); ?></textarea>
                            </div> -->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control counting" name="price" value="<?php echo e(old('price')); ?>">
                                    </div>
                                    <div class="col">
                                        <label class="font-weight-bold">VAT/Tax</label>
                                        <input type="text" class="form-control counting" name="added_price"
                                               value="<?php echo e(old('added_price')); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control counting" name="harbor"
                                               value="<?php echo e(old('harbor')); ?>">
                                    </div>
                                    <div class="col">
                                        <label class="font-weight-bold">Serial #</label>
                                        <input type="text" class="form-control counting" name="sn_no" value="<?php echo e(old('sn_no')); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <textarea name="boat_script" class="form-control" style="min-height: 100px;"><?php echo e(old('boat_script')); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <textarea name="excellent_for specificationFields" class="form-control counting" style="min-height: 300px;"><?php echo e(old('excellent_for')); ?></textarea>
                            </div>
                        </div>
                    </div>
                    <!--Excellent For End-->     
                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <input type="hidden" name="image" id="selected-image" value="<?php echo e(old('image')); ?>">
                            <img src="<?php echo e(old('image')); ?>" alt="Preview" id="preview-image" style="width: 100%;">
                        </div>
                        <div class="card-footer">
                ...
                <div class="col-md-12">
                    <div class="card mt-3">
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                <input type="hidden" name="local_cruising_area" id="selected-image" value="<?php echo e(old('new_local_cruising_area')); ?>">
                                <img src="<?php echo e(old('new_local_cruising_area')); ?>" alt="Preview" id="preview-image" style="width: 100%;">
                            </div>
                            <div class="card-footer">
                ...
                <div class="col-md-12">
                    <div class="card mt-3">
                        <div class="card-body">
                            ...
                            <!-- <div class="card-body">
                                <input type="text" name="old_brochure" id="selected-image" value="<?php echo e(old('brochure')); ?>">
                            </div> -->
                            <div class="card-footer">
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="seo_brad_data" maxlength="1000" rows="10" class="form-control"><?php echo e(old('seo_brad_data')); ?></textarea>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea maxlength="250" name="jkeyword1" class="form-control" style="min-height: 100px;"><?php echo e(old('jkeyword1')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea maxlength="250" name="jkeyword2" class="form-control" style="min-height: 100px;"><?php echo e(old('jkeyword2')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea maxlength="250" name="jkeyword3" class="form-control" style="min-height: 100px;"><?php echo e(old('jkeyword3')); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Keyword 1</label>
                                            <textarea name="urlranking1" class="form-control" style="min-height: 100px;"><?php echo e(old('urlranking1')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Keyword 2</label>
                                            <textarea name="urlranking2" class="form-control" style="min-height: 100px;"><?php echo e(old('urlranking2')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Keyword 3</label>
                                            <textarea name="urlranking3" class="form-control" style="min-height: 100px;"><?php echo e(old('urlranking3')); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Keyword 1</label>
                                            <textarea name="exactkey1" class="form-control" style="min-height: 100px;"><?php echo e(old('exactkey1')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Keyword 2</label>
                                            <textarea name="exactkey2" class="form-control" style="min-height: 100px;"><?php echo e(old('exactkey2')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Keyword 3</label>
                                            <textarea name="exactkey3" class="form-control" style="min-height: 100px;"><?php echo e(old('exactkey3')); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Keyword 1</label>
                                            <textarea name="densitykey1" class="form-control" style="min-height: 100px;"><?php echo e(old('densitykey1')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Keyword 2</label>
                                            <textarea name="densitykey2" class="form-control" style="min-height: 100px;"><?php echo e(old('densitykey2')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Keyword 3</label>
                                            <textarea name="densitykey3" class="form-control" style="min-height: 100px;"><?php echo e(old('densitykey3')); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Keyword 1</label>
                                            <textarea name="varkey1" class="form-control" style="min-height: 100px;"><?php echo e(old('varkey1')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Keyword 2</label>
                                            <textarea name="varkey2" class="form-control" style="min-height: 100px;"><?php echo e(old('varkey2')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Keyword 3</label>
                                            <textarea name="varkey3" class="form-control" style="min-height: 100px;"><?php echo e(old('varkey3')); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Keyword 1</label>
                                            <textarea name="lsikey1" class="form-control" style="min-height: 100px;"><?php echo e(old('lsikey1')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Keyword 2</label>
                                            <textarea name="lsikey2" class="form-control" style="min-height: 100px;"><?php echo e(old('lsikey2')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Keyword 3</label>
                                            <textarea name="lsikey3" class="form-control" style="min-height: 100px;"><?php echo e(old('lsikey3')); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('admin.mainframe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/ncwfegko/public_html/resources/views/admin/pages/boats-add.blade.php ENDPATH**/ ?>