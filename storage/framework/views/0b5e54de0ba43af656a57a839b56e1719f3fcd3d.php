...
<div class="counting">
        <div id="content">
            <section class="position-relative boat-topname">
                <div class="container">
                    <h1 class="unit-1-heading text-color toy-name" data-aos="fade-center" data-aos-duration="1000"><?php echo e($page->page_name); ?></h1>
                </div>
                </section>
...
<?php echo $__env->make('frontend.mainframe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/ncwfegko/public_html/resources/views/frontend/templates/awake.blade.php ENDPATH**/ ?>