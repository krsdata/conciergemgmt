            ...
            <div class="carousel-inner" role="listbox">
                ...
                <?php $__currentLoopData = $slider->slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="carousel-item <?php if($count == 0): ?><?php echo e('active'); ?><?php endif; ?>">
                        <img class="d-block w-100 lazyload" data-src="<?php echo e($ss->image_path); ?>" alt="First slide"> <!-- style="max-height: 750px;"-->
                        <div class="carousel-caption d-none d-md-block mb-5">
                            <div class="block text-left mb-4">
...
<?php echo $__env->make('frontend.mainframe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/ncwfegko/public_html/resources/views/welcome.blade.php ENDPATH**/ ?>