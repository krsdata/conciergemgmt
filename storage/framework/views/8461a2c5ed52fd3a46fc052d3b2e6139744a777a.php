...
<div class="row">
  ...
  <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 img-row">
    ...
    <?php 
      ...
      $thumb_src = str_replace("photos","public/photos",$thumb_src);
    ?>
    <?php 
      $item_path = $item->is_file ? $item->url : $item->path; 
      $item_path = str_replace("photos","public/photos",$item_path);
    ?>
...
<?php endif; ?>
<?php /**PATH /home1/ncwfegko/public_html/resources/views/vendor/laravel-filemanager/grid-view.blade.php ENDPATH**/ ?>