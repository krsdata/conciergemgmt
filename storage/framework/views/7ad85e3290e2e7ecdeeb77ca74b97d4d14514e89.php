<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="<?php echo e(url('/dashboard/contact-forms/add')); ?>" class="btn btn-outline-info">
        ...
        <div class="row">
            ...
            <div class="row table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <?php $__currentLoopData = $forms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="text-center">
                            <td>
                            ...
                            <td><?php echo e($p->short_code); ?></td>
                            
                            <td><?php if(isset($p->pbc)): ?><?php echo e('('.$p->type.') '.$p->pbc); ?><?php endif; ?></td>
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('Do you want to copy this form?')" href="<?php echo e(url('/dashboard/contact-forms/?ref=copy&id='.$p->id)); ?>" class="btn btn-outline-primary">Copy</a>
                                
                                <a href="<?php echo e(url('/dashboard/contact-forms/edit/'.$p->id)); ?>" class="btn btn-outline-info">Edit</a>
                                <?php } if($canDelete){ ?>
                                <a href="#" rel="<?php echo e($p->id); ?>" class="btn btn-outline-danger delete-form" data-toggle="modal" data-target="#delete-form">Delete</a>
...
<?php echo $__env->make('admin.mainframe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/ncwfegko/public_html/resources/views/admin/pages/contact-forms.blade.php ENDPATH**/ ?>