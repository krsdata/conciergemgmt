...
<div id="content">
    ...
    <div class="subloder">
     ...
     <img src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/ajax-loader.gif" />
        ...
        <div id="myCarousel" class="carousel slide carousel-fade carousel-ajax" data-ride="carousel" data-interval="5000">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item <?php if($first == 0): ?><?php echo e('active'); ?><?php endif; ?>">
                    <img class="d-block w-100 lazyload" data-src="<?php echo e($ss->image_path); ?>" alt="yachthampton slides"">
...
<?php echo $__env->make('frontend.mainframe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/ncwfegko/public_html/resources/views/frontend/templates/flyboard.blade.php ENDPATH**/ ?>