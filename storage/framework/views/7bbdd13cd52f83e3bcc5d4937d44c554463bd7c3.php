        ...
        <div id="myCarousel" class="carousel slide carousel-fade carousel-ajax fix-slider" data-ride="carousel" data-interval="5000">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item <?php if($first == 0): ?><?php echo e('active'); ?><?php endif; ?>">
                    <img class="img-fluid w-100 lazyload" data-src="<?php echo e($ss->image_path); ?>" alt="yachthampton slides" style="max-height: 750px;">
...
<?php echo $__env->make('frontend.mainframe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/ncwfegko/public_html/resources/views/frontend/templates/drones.blade.php ENDPATH**/ ?>