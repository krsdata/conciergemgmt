...
<div class="counting">
    ...
    <?php $odd = true; foreach ($destinations as $dest) { if($dest->sort == 0 || $dest->sort == "" || $dest->sort ==  null || $dest->cat_id !== 3) continue; ?>
...
<?php echo $__env->make('frontend.mainframe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/ncwfegko/public_html/resources/views/frontend/templates/dining-destinations.blade.php ENDPATH**/ ?>