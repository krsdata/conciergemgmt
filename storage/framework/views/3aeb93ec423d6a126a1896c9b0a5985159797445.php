                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="breadcrumb">
                            ...
                            <input type="hidden" name="featured_image" id="edit-image" value="<?php echo e(old('image')); ?>">
                            <img src="<?php echo e(old('image')); ?>" alt="Select from below" id="edit-preview" style="width: 100%;">
                        </div>
                    </div>
                </div>
                </form>
...
</div><?php /**PATH /home1/ncwfegko/public_html/resources/views/admin/pages/modals/categories-modals.blade.php ENDPATH**/ ?>