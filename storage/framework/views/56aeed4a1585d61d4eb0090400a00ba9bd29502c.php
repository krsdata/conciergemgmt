            ...
            <div class="modal-body">
                <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" rel="<?php echo e($s->id); ?>" class="custom-control-input slider-id" id="customCheck<?php echo e($s->id); ?>">
...
</div><?php /**PATH /home1/ncwfegko/public_html/resources/views/admin/pages/modals/boats-add-modals.blade.php ENDPATH**/ ?>