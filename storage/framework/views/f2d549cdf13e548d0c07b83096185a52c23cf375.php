<script defer src="<?php echo e(asset('/frontend/range-slider/jquery.min.js')); ?>" type="text/javascript"></script>
<script defer src="<?php echo e(asset('/frontend/range-slider/jquery-ui.min.js')); ?>" type="text/javascript"></script>
<script defer src="<?php echo e(asset('/frontend/range-slider/price_range_script.js?v=2020042006')); ?>" type="text/javascript"></script>
<script defer type="text/javascript" src="<?php echo e(asset('/frontend/range-slider/jquery.ui.touch-punch.min.js')); ?>"></script>
<script defer src="<?php echo e(asset('/frontend/plugins/bootstrap/js/bootstrap.min.js')); ?>"></script>
<script defer src="<?php echo e(asset('/frontend/plugins/bootstrap/js/popper.js')); ?>"></script>
<script defer src="<?php echo e(asset('/frontend/js/lazysizes.min.js')); ?>"></script>
<script src="<?php echo e(asset('/frontend/jquery-3.4.1.min.js')); ?>"></script> 
<script defer src="<?php echo e(asset('/frontend/ekko-lightbox.min.js')); ?>"></script>
...
$("#exampleModalCenterr .modal-body").html("<p>Loading...</p>");$.ajax({headers:{'X-CSRF-TOKEN':$('meta[name="csrf-token"]').attr('content')},type:"GET",url:'<?php echo e(route('loadDestination')); ?>',data:{cat_id:cat_id},dataType:"json",success:function(response){var category_data=response;var option_string='';if(category_data.status==1)
...
$("#exampleModalCenterr .modal-body").html(option_string)}})});setTimeout(function(){$(".flash-message").hide()},3000);$(document).on('click','[data-toggle="lightbox"]',function(event){event.preventDefault();$(this).ekkoLightbox()});$(document).ready(function(){$("#navbar li.dropdown .cmssubmenu").click(function(){$(".navbar-nav .dropdown-menu").toggle()});$("#bestChoiceBoat").change(function(){var boat_id=$(this).val();$.ajax({headers:{'X-CSRF-TOKEN':$('meta[name="csrf-token"]').attr('content')},type:"GET",url:'<?php echo e(route('loadBoatInfo')); ?>',data:{boat_id:boat_id},dataType:"json",success:function(response){var res=response;var option_string='';if(response.status==1)
...
var form_boatLength=[];$('input[name="form_boatLength[]"]:checked').each(function(){form_boatLength.push($(this).val())});var form_destination=[];$('input[name="form_destination[]"]:checked').each(function(){form_destination.push($(this).val())});var form_duration=[];$('input[name="form_duration[]"]:checked').each(function(){form_duration.push($(this).val())});$("#nonFilterBoats").hide();var text='Loading...';$("#filterBoats").html(text);$("#noRecord").hide();$(".optionBox").hide();$('.modal').modal('hide');$.ajax({headers:{'X-CSRF-TOKEN':$('meta[name="csrf-token"]').attr('content')},type:"GET",url:'<?php echo e(route('filterBoats')); ?>',data:{filter:filter,form_min:form_min,form_max:form_max,form_boatType:form_boatType,form_departure:form_departure,form_mincap:form_mincap,form_maxcap:form_maxcap,form_minsleep:form_minsleep,form_maxsleep:form_maxsleep,form_boatLength:form_boatLength,form_destination:form_destination,form_duration:form_duration},dataType:"json",success:function(response){var res=response;if(res.status==1){$("#filterBoats").html(res.data)}
...
<?php endif; ?>
<?php if($title != "Yacht Hampton | Best Charter in The Hamptons"): ?>
<?php endif; ?>

<script defer src="<?php echo e(asset('/frontend/plugins/magnific-popup/dist/jquery.magnific-popup.min.js')); ?>"></script>
<script defer src="<?php echo e(asset('/frontend/plugins/slick-carousel/slick/slick.min.js')); ?>"></script>
...
<script defer src="<?php echo e(asset('/frontend/js/script.js?v=2020042001')); ?>"></script>
<script defer src="<?php echo e(asset('/frontend/js/aos.js')); ?>"></script>
<script defer src="<?php echo e(asset('/frontend/js/main.js')); ?>"></script>
<script defer src="<?php echo e(asset('/frontend/sidemenu/main.js?v=2020042014')); ?>"></script>
<?php /*
...
<?php endif; ?><?php /**PATH /home1/ncwfegko/conciergemgmt.yachthampton.com/public_html/resources/views/frontend/includes/javascripts.blade.php ENDPATH**/ ?>