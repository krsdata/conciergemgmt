...
<div class="col-md-12">
    ...
    <p><img class="img-fluid mt-3 mb-3 lazyload cruising-area" data-src="public/photos/2/<?php echo e($page->new_local_cruising_area); ?>" src="/public/photos/2/<?php echo e($page->new_local_cruising_area); ?>" alt="coastal concierge boats local cruising area" /></p>
</div>
</div>
</div>
</div>    
...
<?php echo $__env->make('frontend.mainframe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/ncwfegko/conciergemgmt.yachthampton.com/public_html/resources/views/frontend/pages/single-boat.blade.php ENDPATH**/ ?>