    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo e(url('/dashboard/boats-delete')); ?>">
                    <?php echo csrf_field(); ?>
...
</div><?php /**PATH /home1/ncwfegko/public_html/resources/views/admin/pages/modals/boats-modals.blade.php ENDPATH**/ ?>