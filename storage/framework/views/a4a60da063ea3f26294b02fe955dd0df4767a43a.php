        ...
        <div class="subloder">
         ...
         <img src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/ajax-loader.gif" />
            ...
            <div id="single-product" class="single-product owl-carousel owl-theme">
                ...
                <?php /*
                <img class="owl-lazy" data-src="{{ $ss->image_path }}" alt="yachthampton slides" style="height:auto;" />
                 <?php $first++; ?> */ ?>
...
<?php echo $__env->make('frontend.mainframe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/ncwfegko/public_html/resources/views/frontend/templates/tender.blade.php ENDPATH**/ ?>