...
<style>
    .featured-image{background:url("<?php echo e($page->featured_image); ?>") no-repeat 50% 50%;background-size:cover} 
</style>
...
<section class="section about position-relative bg-gray">
 ...
 <div class="col-md-6 col-sm-12" data-aos="fade-right" data-aos-duration="1000">
                    <div class="about-item">
                        <img class="d-block w-100 lazyload" data-src="<?php echo e(asset('/photos/2/bachelor-party/man-on-boat.jpg')); ?>">
                    </div>
                </div>
    ...
    <section class="section about position-relative bg-gray pt-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12" data-aos="fade-left" data-aos-duration="1000">
                    <div class="about-item">
                        <img class="d-block w-100 lazyload" data-src="<?php echo e(asset('/photos/2/bachelor-party/stag-party-Catamaran-yhc.jpg')); ?>">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12" data-aos="fade-right" data-aos-duration="1000">
                    <div class="about-item">
                        ...
                        <img class="d-block w-100 lazyload" data-src="<?php echo e(asset('/photos/2/bachelor-party/drinks-on-hbr.jpg')); ?>">
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12"  data-aos="fade-left" data-aos-duration="1000">
                    ...
                    <div class="about-item">
                        ...
                        <img class="d-block w-100 lazyload" data-src="<?php echo e(asset('/photos/2/bachelor-party/party-encouraged-yhc.jpg')); ?>">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12" data-aos="fade-right" data-aos-duration="1000">
                    <div class="about-item">
                        ...
                        <img class="d-block w-100 lazyload" data-src="<?php echo e(asset('/photos/2/bachelor-party/yhc-patron-en-bachelor.jpg')); ?>">
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12" data-aos="fade-left" data-aos-duration="1000">
                    ...
                    <div class="about-item">
                        ...
                        <img class="d-block w-100 lazyload" data-src="<?php echo e(asset('/photos/2/bachelor-party/yhc-yacht-jump.jpg')); ?>">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12" data-aos="fade-right" data-aos-duration="1000">
                    <div class="about-item">
                        ...
                        <img class="d-block w-100 lazyload" data-src="<?php echo e(asset('/photos/2/bachelor-party/yhc-bachelor-parties.jpg')); ?>">
                    </div>
    ...
    <section>
        <img class="d-block w-100" data-aos="fade-center" data-aos-duration="1000" src="<?php echo e(asset('/photos/2/bachelor-party/ska-yachthampton.jpg')); ?>">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="about-item">
                        ...
                        <img class="d-block w-100 lazyload" data-aos="fade-right" data-aos-duration="1000" data-src="<?php echo e(asset('/photos/2/bachelorette-party/bachelor-sundancer.jpg')); ?>">
                    </div>
    ...
    <section>
        <img class="d-block w-100 lazyload" data-aos="fade-center" data-aos-duration="1000" data-src="<?php echo e(asset('/photos/2/bachelor-party/guys-beach-pac.jpg')); ?>">
...
<?php echo $__env->make('frontend.mainframe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/ncwfegko/public_html/resources/views/frontend/templates/bachelor-party.blade.php ENDPATH**/ ?>