                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="{{ route('admin.signup.submit') }}">
                                    @csrf
                                    <div class="form-group">
                                        <input class="form-control form-control-user" value="{{old('name')}}" required="" name="name" id="name" placeholder="Name" type="text">
                                    </div>

                                    <div class="form-group">
                                        <input class="form-control form-control-user" value="{{old('email')}}" required="" name="email" id="email" placeholder="Email" type="email">
                                    </div>

                                    <div class="form-group">
                                        <input class="form-control form-control-user" value="{{old('phone')}}" required="" name="phone" id="phone" placeholder="Phone Number" type="text">
                                    </div>
