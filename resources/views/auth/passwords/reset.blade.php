        ...
        <div class="col-md-8 mt-5">
            <div class="card">
                ...
                <div class="text-center">
                    <h1 class="h4 text-gray-900 mt-4">{{ __('Reset Password') }}</h1>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('reset.password.update') }}" class="user">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" readonly="" type="email" class="form-control form-control-user @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
