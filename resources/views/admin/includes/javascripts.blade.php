...
<link href="{{ asset('/admin/rich-text/jquerysctipttop.css') }}" rel="stylesheet" type="text/css">
<link rel="stylesheet" href="https://netdna.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
<link rel="stylesheet" href="{{ asset('/admin/rich-text/site.css') }}">
<link rel="stylesheet" href="{{ asset('/admin/rich-text/richtext.min.css') }}">
<!--<script src="https://code.jquery.com/jquery-1.12.4.min.js"></script>-->
<script src="{{ asset('/admin/rich-text/jquery.richtext.js') }}"></script>
  ...
  $(function() {
    $('.toggle-class').change(function() {
        ...
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "{{ url('dashboard/changeinstastatus') }}",
