...
<script>
    var edit = {};
    @if($forms->components != null)
        var edit = JSON.parse(decodeURIComponent("{{ $forms->components }}"));
        $('#form-comp').val(encodeURIComponent(JSON.stringify(edit)));
    @endif
    var boats = [];
    @if(!empty($raw_boats))
    ...
    Formio.builder(document.getElementById('builder'), edit, {
        builder: {
            basic: false,
            advanced: false,
            data: false,
