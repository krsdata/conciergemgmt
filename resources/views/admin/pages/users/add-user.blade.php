...
@section('content')
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><?php if($userData['name'] == '') echo "Add User"; else echo "Update User" ?>  </li>
        </ol>
                            ...
                            <div class="row">
		                                	...
		                                	<?php 
		                                		if(count($UserRole)) {
		                                			foreach ($UserRole as $r) {
		                                				$selected = "";
		                                				if($r->id == $userData['role_id'])
		                                					$selected = 'selected="selected"';


		                                	?>
		                                	<option <?php echo $selected ?> value="<?php echo $r->id ?>"><?php echo $r->role ?></option>
		                                	<?php }} ?>
		                                </select>
		                            </div>
		                        </div>
		                        ...
		                        <div class="col-md-6">
		                            <div class="form-group">
		                                ...
		                                <input class="form-control" required="" value="<?php echo $userData['phone'] ?>" name="phone" id="phone" type="text">
		                            </div>
		                        </div>
		                        ...
		                        <div class="col-md-6">
		                            <div class="form-group">
		                                ...
		                                <select class="form-control" name="status" id="status">
		                                	<option <?php if($userData['status'] == 'active') echo 'selected="selected"' ?> value="active">Active</option>
		                                	<option <?php if($userData['status'] == 'inactive') echo 'selected="selected"' ?> value="inactive">Inactive</option>
		                                </select>
		                            </div>
		                        </div>
