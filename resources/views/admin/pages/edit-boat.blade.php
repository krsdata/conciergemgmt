...
<div class="container-fluid">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="{{ url('/dashboard/boats') }}">Boats</a>
        </li>
        <li class="breadcrumb-item active">{{ $boat->title }}</li>
    </ol>

    @include('admin.includes.messages')

    <form method="POST" action="{{ url('/dashboard/boats/'.$boat->id) }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control col-md-8" name="page_name" type="text"
                                   value="{{ $boat->page_name }}">
                        </div>
                        <div class="form-group">
                            <label class="font-weight-bold">Slug/Link</label>
                            <input class="form-control col-md-8" name="slug" type="text" value="{{ $boat->slug }}">
                        </div>
                        
                        <!--   <div class="form-group">
                            <label class="font-weight-bold">Content</label>
                            <textarea name="content" class="form-control my-editor"
                                      style="min-height: 500px;">{{ $boat->content }}</textarea>
                        </div> -->
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" name="sn_no" value="{{ $boat->sn_no }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="col">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" name="4_hour" class="custom-control-input"
                                               id="4-hour" @if(isset($extra['4_hour']) && $extra['4_hour'] == 'on'){{ 'checked' }}@endif>
                                ...
                                <div class="col">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" name="8_hour" class="custom-control-input"
                                               id="8-hour" @if(isset($extra['8_hour']) && $extra['8_hour'] == 'on'){{ 'checked' }}@endif>
                                ...
                                <div class="col">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" name="best_seller" class="custom-control-input"
                                               id="best-seller" @if(isset($extra['best_seller']) && $extra['best_seller'] == 'on'){{ 'checked' }}@endif>
                                ...
                                <div class="col">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" name="jet_ski" class="custom-control-input"
                                               id="jet-ski" @if(isset($extra['jet_ski']) && $extra['jet_ski'] == 'on'){{ 'checked' }}@endif>
                                ...
                                <div class="col-md-3">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" name="day_trips" class="custom-control-input"
                                               id="day_trips" @if(isset($extra['day_trips']) && $extra['day_trips'] == 'on'){{ 'checked' }}@endif>
                                ...
                                <div class="col-md-3">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" name="overnights" class="custom-control-input"
                                               id="overnights" @if(isset($extra['overnights']) && $extra['overnights'] == 'on'){{ 'checked' }}@endif>
                                ...
                                <div class="col">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" name="sea_bob" class="custom-control-input"
                                               id="sea_bob" @if(isset($extra['sea_bob']) && $extra['sea_bob'] == 'on'){{ 'checked' }}@endif>
                                 ...
                                 <div class="col">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" name="brand_new" class="custom-control-input"
                                               id="brand_new" @if(isset($extra['brand_new']) && $extra['brand_new'] == 'on'){{ 'checked' }}@endif>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea name="boat_script" class="form-control" style="min-height: 100px;">{{ $boat->boat_script }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="category">
                                        ...
                                        @foreach($categories as $c)
                                            <option value="{{ $c->id }}" @if($c->id == $boat->cat_id){{ 'selected' }}@endif>{{ $c->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                               <!--  <button type="button" class="btn btn-outline-info btn-block">Preview</button> -->
                                 ...
                                 <a href="@if($boat->slug == '/'){{ url('/') }}@else{{ url('/'.$boat->slug) }}@endif" target="_blank" class="btn btn-outline-info btn-block">Preview</a>
                    ...
                    <div class="card-body">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="size" value="{{ $extra['size'] }}">
                            </div>
                            <div class="form-group">
                                <label class="font-weight-bold">Miles/Hour</label>
                                <input type="text" class="form-control" name="speed" value="{{ $extra['speed'] }}">
                            </div>
                            <div class="form-group">
                                <label class="font-weight-bold">Capacity</label>
                                <input type="text" class="form-control" name="capacity" value="{{ $extra['capacity'] }}">
                            </div>
                            <div class="form-group">
                                <label class="font-weight-bold">Beds</label>
                                <input type="text" class="form-control" name="beds" value="{{ $extra['beds'] }}">
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <input type="hidden" name="image" id="selected-image" value="{{ $boat->image }}">
                        <img src="{{ $boat->image }}" alt="Preview" id="preview-image" style="width: 100%;">
                    </div>
                    <div class="card-footer">
                 ...
                 <div class="card mt-3">
                    ...
                    <div class="card-body" id="headingcontentRow">
                        ...
                        <div class="row" id="headingcontentFields<?php echo $i ?>">    
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <textarea name="contentnew[]" class="content<?php echo $i ?>">{{ $hcontent2->content }}</textarea>
                                </div>
                            </div>
                        </div>
                        <?php $i++; }} ?>
            ...
            <div class="col-md-12">
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <input type="hidden" name="local_cruising_area" id="selected-image" value="{{ $boat->new_local_cruising_area }}">
                            <img src="{{ asset('/photos/2/'.$boat->new_local_cruising_area) }}" alt="Preview" id="preview-image" style="width: 50px;">
                        </div>
                        <div class="card-footer">
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body" id="headingcontentRow2">
                        ...
                        <div class="row" id="headingcontentFieldsTwo<?php echo $i ?>">    
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <textarea name="content_two[]" class="contentTwo<?php echo $i++ ?>">{{ $hc->content_two }}</textarea>
                                </div>
                            </div>
                        </div>
                        <?php $i++; }} ?>
            ...
            <div class="col-md-12">
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <input type="hidden" value="{{ $boat->brochure }}" name="oldbrochure">
                            <label>{{ $boat->brochure }}</label>
                        </div>
                        <div class="card-footer">
            ...
            <div class="col-md-12">
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <input type="hidden" value="{{ $boat->specification_pdf }}" name="old_specification_pdf">
                            <label>{{ $boat->specification_pdf }}</label>
                        </div>
                        <div class="card-footer">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea name="meta_keyword" class="form-control"
                                      >{{ $boat->meta_keyword }}</textarea>
                        </div>

                        <div class="form-group">
                            <label class="font-weight-bold">Meta Description</label>
                            <textarea name="meta_description" class="form-control">{{ $boat->meta_description }}</textarea>
                        </div>
