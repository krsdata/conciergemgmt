...
<div class="modal fade" id="delete-slide" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ url('/dashboard/sliders/delete') }}">
                    @csrf
                    <label>Do you really want to delete the slider image?</label>
