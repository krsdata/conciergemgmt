            ...
            <div class="rows" id="nonFilterBoats">
                ...
                <div class="col-md-12" id="boats">
                    ...
                    <div class="containers mb-5 pt-3 pb-3 boat-header">
                        <p class="mb-1 mt-2 font-tenor">{{ $c->title }}</p>
                    </div>
                                        ...
                                        */ ?>
                                        <div class="ourboatbox">
                                            <a href="{{url('/'.$b->slug->slug) }}" target="_blank">
                                                ...
                                                <span class="boat-no">{{ $b->sn_no }}</span>
                                            </a>
                                        </div>
                                    <div class="row">
                                            <div class="col-lg-12">
                                        ...
                                        <div class="blog-item-content bg-white p-1 boat_it">
                                            <h3 class="boat-heading mb-4 pt-2">
                                                <a href="{{ $b->slug->slug }}" target="_blank">{{ $b->page_name }} <span class="place"><i class="fas fa-map-marker-alt"></i>@foreach($b->details as $bd)@if($bd->key == 'harbor'){{ $bd->value }}@endif @endforeach</span></a>
                                            </h3>
                                            <div class="mb-4 boat-pricing">
                                                <strong>From $@foreach($b->details as $bd)@if($bd->key == 'price'){{ substr($bd->value, 0, -1) }}@endif @endforeach</strong> @foreach($b->details as $bd)@if($bd->key == 'added_price'){{'+ '.$bd->value}} @endif @endforeach
                                                <a href="{{ $b->slug->slug }}" class="learn-more">Learn more</a>
                                            </div>
                                            <div class="mb-4 boat-info">
                                                <span class="mr-3">
                                                    <i class="fas fa-ruler-horizontal"></i>@foreach($b->details as $bd)@if($bd->key == 'size'){{ $bd->value }}@endif @endforeach FEET
                                                </span> <?php /*
                                                ...
                                                <span class="mr-3">
                                                    <i class="fas fa-user-friends"></i>@foreach($b->details as $bd)@if($bd->key == 'capacity'){{ $bd->value }}@endif @endforeach PEOPLE
                                                </span> <?php /*
