                ...
                <div class="carousel-inner">
                    ...
                    @foreach($slider->slides as $ss)
                        <div class="carousel-item @if($count == 0){{ 'active' }}@endif">
                            <img class="img-fluid w-100 lazyload" data-src="{{ $ss->image_path }}" alt="First slide">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12" data-aos="fade-right" data-aos-duration="1000">
                    <div class="about-item">
                        <img class="d-block w-100 lazyload" data-src="{{ asset('/photos/2/kokomos/waitress_kokomos.jpg') }}">
                    </div>
                </div>
