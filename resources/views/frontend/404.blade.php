    ...
    <div id="main">
    	<div class="fof">
            <div class="box">
                ...
                <p><a href="{{ url('/') }}" class="text-white">Take me where the boats are!</a></p>
            </div>
    	</div>
...
@keyframes type{
    ...
    .not-found{background:url("{{ asset('/frontend/images/bg/counter.jpg') }}") no-repeat 50% 50%;background-size:cover}
    a {    color: #242424;}
