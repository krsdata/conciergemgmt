...
<section class="homeContactSection">
    ...
    <div class="row">
        <div class="col-md-12">
            <h2 class="font-weight-bold text-uppercase text-center contact-title aos-init aos-animate" data-aos="flip-up" data-aos-delay="300">{{ $contact_form->title }}</h2>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="widget footerLogoBox">
                      ...
                      <a href="./"><img class="img-responsive lazyload" data-src="{{ asset('/coastal-concierge-logo-175w.png') }}" alt="coastal-concierge-footer-logo"/></a>
                      </div> 
